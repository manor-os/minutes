    ...
    <div className="app app-minimal">
      <header className="app-header">
        <div className="header-left">
          <h1>
            <img src="/minutes-product-mark.svg" alt="" className="app-brand-icon" />
            <span className="app-wordmark">Minutes</span>
          </h1>
        </div>
        <div className="header-right">
          <nav className="nav-tabs">
            <button
              ...
              aria-current={view === "recorder" ? "page" : undefined}
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
                urlMeetingHandled.current = true;
