    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-header">
          <div className="login-brand"><img src="/minutes-product-mark.svg" alt="" className="app-brand-icon" /><span>Minutes</span></div>
        ...
        {IS_CLOUD ? <details className="login-email-option"><summary>Use email instead</summary>{emailForm}</details> : emailForm}
