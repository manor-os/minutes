...
import { BarChartIcon, ClockIcon, DollarIcon } from './Icons';
...
function UsageStats({ onClose }) {
  ...
  const modalContent = (
    <div className="usage-modal" onClick={onClose}>
      <div className="usage-content" role="dialog" aria-modal="true" aria-labelledby="usage-title" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="usage-body">
          ...
          {stats && !loading && (
            <>
              ...
              <details className="usage-breakdown"><summary>Usage details</summary><div className="usage-grid">
                <div className="usage-card">
              ...
              <details className="usage-activity">
                <summary>Activity <span>7 days</span></summary>
