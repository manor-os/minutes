    ...
    <div className="settings-modal" onClick={onClose}>
      <div className="settings-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="settings-body">
              ...
              <div className="form-group checkbox-group">
                <label className="checkbox-label">
                  ...
                  <span className="checkbox-text">
                    ...
                    <span className="checkbox-description">
                      Automatically refresh the meetings list
                    </span>
                  </span>
                </label>
              </div>
              ...
              {formData.autoRefresh && (
                <div className="form-group">
                  ...
                  <p className="form-help">
                    How often to refresh the meetings list (3-60 seconds)
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="settings-section">
            ...
            <div className="settings-form">
              <div className="form-group">
                ...
                <p className="form-help">
                  Language of the audio. Auto-detect works for most cases.
                </p>
              </div>
          ...
          <div className="settings-section">
            ...
            <div className="settings-form">
              <div className="form-group">
                ...
                />
                <p className="form-help">
                  Supports Slack, Discord, or any webhook URL. Leave empty to
                  disable.
                </p>
              </div>
            </div>
          ...
          {IS_COMMUNITY && (
            <div className="settings-section">
              ...
              <div className="settings-form">
                <p
                  className="settings-section-desc"
                  style={{ margin: "0 0 8px 0", color: "#dc2626" }}
                >
                  Danger Zone
                </p>
                {!showDeleteConfirm ? (
          ...
          {/* Messages */}
          {successMessage && (
            <div className="settings-message success">{successMessage}</div>
          )}

          {errorMessage && (
            <div className="settings-message error">{errorMessage}</div>
          )}
        </div>
